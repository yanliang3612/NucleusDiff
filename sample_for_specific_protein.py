...
if __name__ == '__main__':
    ...
    parser.add_argument('--pdb_path', type=str, default="./path_to_your_protein/your_protein.pdb")
    parser.add_argument('--device', type=str, default='cuda:0')
    parser.add_argument('--batch_size', type=int, default=100)
    parser.add_argument('--result_path', type=str, default='./path_to_your_result')
