...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_path', type=str, default='./read_world_cdk2_test')
    ...
    parser.add_argument('--protein_root', type=str,default='./surfgen_real_world/cdk2_processed.pdb')
    parser.add_argument('--atom_enc_mode', type=str, default='add_aromatic')
    parser.add_argument('--docking_mode', type=str, default='vina_dock',choices=['qvina', 'vina_score', 'vina_dock', 'none'])
    parser.add_argument('--ligand_filename', type=str, default='3CL')
    ...
    vina_score_list = {"3CL": {"vina": -6.473}, "AKT1": {"vina": -9.683}, "CDK2": {"vina": -8.029}}
        ...
        for sample_idx, (pred_pos, pred_v) in enumerate(zip(all_pred_ligand_pos, all_pred_ligand_v)):
            ...
            try:
                ...
                if args.docking_mode == 'qvina':
                    vina_task = QVinaDockingTask.from_generated_mol_real_world(
                        mol, args.ligand_filename, protein_root=args.protein_root)
                    vina_results = vina_task.run_sync()
                elif args.docking_mode in ['vina_score', 'vina_dock']:
                    vina_task = VinaDockingTask.from_generated_mol_real_world(
                        mol, args.ligand_filename, protein_root=args.protein_root)
            ...
            vina_dock_score = vina_score_list[args.ligand_filename]['vina']
