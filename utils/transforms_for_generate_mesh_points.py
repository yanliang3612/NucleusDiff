...
MAP_ATOM_TYPE_AROMATIC_TO_INDEX_FOR_Mesh_Points = {
    (6, False): 1,
    (6, True): 2,
    (7, False): 3,
    (7, True): 4,
...
MAP_INDEX_TO_ATOM_TYPE_AROMATIC = {v: k for k, v in MAP_ATOM_TYPE_AROMATIC_TO_INDEX_FOR_Mesh_Points.items()}

MAP_INDEX_TO_ATOM_TYPE_FULL = {v: k for k, v in MAP_ATOM_TYPE_FULL_TO_INDEX.items()}


def get_atomic_number_from_index_generate_mesh_points(index, mode):
    if mode == 'basic':
